...
| `tree-green` | prop | 0.48–1.73 | 0.80–2.88 | 8.16 m | ×4.80 | ok |
...
| `cloud` | météo | 2.88–6.74 | 0.85–1.93 | 5.46 m | ×3.21 | — |
...
| `char-scout` | héros (ville) | 0.53 | 0.94 | 2.67 m | ×1.57 | — |
...
| `mob-goblin` | monstre | 0.42 | 0.45 | 1.28 m | ×0.76 | — |
...
| `snowman` | prop | 0.37 | 0.39 | 1.09 m | ×0.64 | ok |
...
| `tumbleweed` | météo | 0.18–0.26 | 0.17–0.26 | 0.74 m | ×0.43 | ok |
...
**0 asset(s) hors fourchette** sur 49 mesurés.
