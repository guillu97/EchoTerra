...
// name (shown in the top bar and used to name server-created public games). Names
// combine a root + ending, with an occasional epithet, giving ~10k combinations —
// collisions across games are harmless (the game id stays the key).
