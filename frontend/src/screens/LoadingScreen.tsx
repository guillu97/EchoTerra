...
export function LoadingScreen() {
  ...
  return (
    <div className="screen parchment">
      ...
      <button className="screen-tap" onClick={() => setScreen("title")} aria-label={t("Passer le chargement")}>
        <Logo />
        <span className="loading-bar" role="progressbar" aria-label={t("Chargement")}>
          <i />
        </span>
      </button>
