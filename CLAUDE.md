...
pour 1 · 4 · 12 · 20 joueurs.** Historique complet : `journal.md` (entrées 94 et 97).

⚠ **DEUX PIÈGES QUI ONT FAIT MENTIR L'INSTRUMENT** (2026-08-09, entrée 97) — les deux invisibles :
...
**Comportement des bots — deux règles trouvées à la mesure** (entrée 97) : un récolteur **se fixe un
