...
| vire-vent | 1,04 m (plus gros qu'un rocher, cf. entrée 129) | 0,75 m |
...
- `test:weather` **19/19** (dont la taille du vire-vent, et la visibilité inchangée : 1,96 boule à
  l'écran) — le flake « on-demand » des entrées 127 et 129 est repassé au vert de lui-même, confirmant
...
## 2026-08-17 (129) — Les vire-vents faisaient la taille d'un héros
...
## 2026-08-16 (125) — Le brouillard de guerre, la tour de guet, et la vision en combat
...
## 2026-08-16 (124) — Les objets des deux statistiques, et le relief qui arrête enfin
...
## 2026-08-16 (123) — Audit des stats, économie du tour et recharges : le combat cesse de se jouer tout seul
